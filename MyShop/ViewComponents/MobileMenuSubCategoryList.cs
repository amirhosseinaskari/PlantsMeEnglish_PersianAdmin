...
{
    [ViewComponent]
    public class MobileMenuSubCategoryList : ViewComponent
    {
        private readonly ApplicationDbContext _db;
        public MobileMenuSubCategoryList(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        
        {
            ...
            return View(viewName: "MobileMenuSubCategoryList", model: mainCategories);
