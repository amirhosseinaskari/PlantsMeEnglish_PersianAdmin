            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        ...
                        $(elems).attr('uk-tooltip', 'title: انتشار');
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">' + successMessage + '</span>',
                            status: 'primary',
                            pos: 'top-center',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        ...
                        $(elems).attr('uk-tooltip', 'title: عدم انتشار');
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">' + successMessage + '</span>',
                            status: 'primary',
                            pos: 'top-center',
        ...
        $('#product-add-modal__form button[type="submit"]').click(function (e) {
            ...
            if (catId === -1 || catId === "-1") {
                ...
                $('.error-select-category').removeClass('d-none')
                    .html('انتخاب دسته بندی الزامی است (ابتدا یک دسته بندی ایجاد کنید)');
                return false;
            }
            ...
            if ($(myTitle).val().trim() === "" || $(myTitle).val() === null) {
                ...
                $('#product-add-modal__form span.error-title')
                    .html('تعیین کردن نام محصول الزامی است')
                    .removeClass('d-none');
                e.stopPropagation();
                e.preventDefault();
                return false;
...
//---Publish a group of products in product list page-----------
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">محصولات انتخاب شده انتشار یافتند</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 3000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار محصولات مورد نظر لغو گردید</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 3000
                    });
    ...
    $('#HasFreeDelivery').change(function () {
        ...
        let result = false;
        let successMessage = "ارسال رایگان تغییر یافت";
        let errorMessage = "تغییر آپشن ارسال رایگان با خطا مواجه شد";
        if (isChecked) {
            $(this).prop('checked', true);
            result = true;
            successMessage = "آپشن ارسال رایگان به این محصول اضافه شد";
        } else {
            $(this).prop('checkec', false);
            result = false;
            successMessage = "آپشن ارسال رایگان از این محصول حذف شد";
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">' + errorMessage + '</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('#AuthotityGuarantee').change(function () {
        ...
        let productId = $(this).attr('data-productId');
        let result = false;
        let successMessage = "ضمانت اصالت کالا تغییر یافت";
        let errorMessage = "تغییر آپشن ضمانت اصالت کالا با خطا مواجه شد";
        if (isChecked) {
            $(this).prop('checked', true);
            result = true;
            successMessage = "آپشن ضمانت اصالت کالا به این محصول اضافه شد";
        } else {
            $(this).prop('checkec', false);
            result = false;
            successMessage = "آپشن ضمانت اصالت کالا از این محصول حذف شد";
        }
    ...
    $('#LocalPayment').change(function () {
        ...
        let productId = $(this).attr('data-productId');
        let result = false;
        let successMessage = "امکان پرداخت در محل تغییر یافت";
        let errorMessage = "تغییر آپشن امکان پرداخت در محل با خطا مواجه شد";
        if (isChecked) {
            $(this).prop('checked', true);
            result = true;
            successMessage = "آپشن امکان پرداخت در محل به این محصول اضافه شد";
        } else {
            $(this).prop('checkec', false);
            result = false;
            successMessage = "آپشن امکان پرداخت در محل از این محصول حذف شد";
        }
    ...
    $('#ReturnMonyGuarantee').change(function () {
        ...
        let productId = $(this).attr('data-productId');
        let result = false;
        let successMessage = "ضمانت بازگشت کالا تغییر یافت";
        let errorMessage = "تغییر آپشن ضمانت بازگشت کالا با خطا مواجه شد";
        if (isChecked) {
            $(this).prop('checked', true);
            result = true;
            successMessage = "آپشن ضمانت بازگشت کالا به این محصول اضافه شد";
        } else {
            $(this).prop('checkec', false);
            result = false;
            successMessage = "آپشن ضمانت بازگشت کالا از این محصول حذف شد";
        }
    ...
    try {
        ...
        $(document).on('click', '.relatedCategory__submit-button', function (e) {
            ...
            $.ajax({
                url: "/Admin/RelatedCategory/AddToRelatedCategory",
                type: "POST",
                data: {
                    productId: productId,
                ...
                success: function (data) {
                    if (data) {
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">دسته بندی اضافه شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 4000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در اضافه کردن دسته بندی</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 4000
                        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(thisElem).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">دسته بندی حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 4000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در حذف دسته بندی</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 4000
                    });
    ...
    $(document).on('click','.product-description-form__submit-button',function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">متن توضیحات تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click', '.product-option-form__submit-button', function (e) {
        ...
        if (optionTitle === null || $.trim(optionTitle) === "") {
            $('#productOption-title-error').removeClass('d-none')
                .html('وارد کردن این فیلد الزامی است');
            return false;
        }
        ...
        let productId = $(this).attr('data-productId');
        $.ajax({
            url: "/Admin/ProductOption/AddProductOption",
            type: "POST",
            data: {
                productId: productId,
                title: optionTitle,
            ...
            success: function (data) {
                ...
                UIkit.notification({
                    message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">مشخصه جدید اضافه شد</span>',
                    status: 'primary',
                    pos: 'top-center',
                    timeout: 5000
                });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    trParent.remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">آیتم مورد نظر حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click','.product-content-text__submit-button',function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">متن مورد نظر تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click','.product-content-image__submit-button',function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">نوشته جایگزین مورد نظر تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click','.product-tag-form__submit-button',function (e) {
        ...
        if (myText === null) {
            $(parent).find('.error-tag-title').removeClass('d-none')
                .html('تعیین کردن عنوان تگ الزامی است');
        ...
        $.ajax({
            url: "/Admin/ProductTag/CreateTag",
            type: "POST",
            data: {
                id: myProductId,
                text: myText
            ...
            success: function (data) {
                ...
                UIkit.notification({
                    message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تگ جدید اضافه شد</span>',
                    status: 'primary',
                    pos: 'top-center',
                    timeout: 5000
                });
    ...
    $(document).on('click','.seo-setting-form__submit-button',function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات سئو ثبت شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input.product-publishment').change(function (e) {
        ...
        if (state) {
            $(this).prop('checked', true);
            publishment = true;
            message = "محصول انتشار یافت";
        } else {
            $(this).prop('checked', false);
            publishment = false;
            message = "انتشار محصول لغو گردید";
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">' + message + '</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    try {
        ...
        $(document).on('click','.product-variation-form__submit-button',function (e) {
            ...
            if (myvarTitle === "") {
                $('#var-title-error').removeClass('d-none').html('تعیین کردن نام متغیر الزامی است');
            ...
            let successMessage = "متغیر جدید برای این محصول اضافه شد";
            let errorMessage = "اضافه کردن متغیر جدید برای این محصول با خطا مواجه شد";
            $.ajax({
                url: "/Admin/ProductVariation/CreateProductVariation",
                type: "POST",
                data: {
                    productId: proId,
                    varTitle: myvarTitle,
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(parent).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">قیمت ثبت شده برای این زیرمجموعه حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
            ...
            success: function (data) {
                if (data) {
                    if (val === "true") {
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">امکان ارسال به همه شهرها فعال شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">امکان ارسال به همه شهرها لغو شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
        ...
        $(document).on('click', '.add-city-delivery-price--button', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">قیمت ارسال کالای شهر مورد نظر اضافه شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">نوع محاسبه هزینه ارسال شهرها تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click', '.delete-city-price-delivery-icon', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#city-price-delivery--table').html(data);
                UIkit.notification({
                    message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">هزینه ارسال شهر مورد نظر حذف شد</span>',
                    status: 'primary',
                    pos: 'top-center',
                    timeout: 5000
                });
    ...
    $('input[name="HasMinAmountForFreeDelivery"]').change(function () {
        ...
        $.ajax({
            url: "/Admin/Delivery/EditHasMinAmountForFreeDelivery",
            type: "POST",
            data: {
            ...
            success: function (data) {
                ...
                UIkit.notification({
                    message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">وضعیت حداقل مبلغ خرید برای ارسال رایگان تغییر یافت</span>',
                    status: 'primary',
                    pos: 'top-center',
                    timeout: 5000
                });
    ...
    $(document).on('click', '.set-min-amount-for-free-delivery--button', function (e) {
        ...
        if (amount === null || amount.trim() === "") {
            $('.error-delivery-amount').removeClass('d-none').html('وارد کردن مبلغ الزامی است');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حداقل مبلغ خرید برای ارسال رایگان ثبت شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input[name="IsFreeForBuyValue"]').change(function () {
        let val = $(this).val();
        $.ajax({
            url: "/Admin/Delivery/EditIsDifferentForEachProduct",
            type: "POST",
            data: {
            ...
            success: function (data) {
                if (val === "true") {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">هزینه یکسان ارسال کالا برای همه کالاها لغو گردید</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">هزینه یکسان ارسال کالا برای همه کالاها ثبت شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('#discount-add-modal button[type="submit"]').click(function (e) {
        ...
        if (code === null || code.trim() === "") {
            $('.error-code').removeClass('d-none').html('وارد کردن کد الزامی است');
        ...
        if (number === null || number.trim() === "") {
            $('.error-number').removeClass('d-none').html('وارد کردن تعداد الزامی است');
        ...
        if (percent === null || percent.trim() === "" || percent.trim() === 0) {
            $('.error-percent').removeClass('d-none').html('وارد کردن درصد الزامی است');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (!data) {
                    $('.error-code').removeClass('d-none').html('این کد قبلا ثبت شده است');
                    $('input[name="Code"]').css('border-color', 'red');
                    e.stopPropagation();
                    e.preventDefault();
                    return false;
    ...
    $('.total-information__submit-button').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">مشخصات اصلی تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات با خطا مواجه شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input[name="DiscountTarget"]').on('onSomeProduct', function () {
        let myid = $(this).attr('data-id');
        $.ajax({
            url: "/Admin/Discount/ChooseProductsForDiscountTarget",
            type: "POST",
            data: {
                id: myid
            },
    ...
    $('input[name="DiscountTarget"]').on('onSomeCategory', function () {
        let myid = $(this).attr('data-id');
        $.ajax({
            url: "/Admin/Discount/ChooseCategoriesForDiscountTarget",
            type: "POST",
            data: {
                id: myid
            },
    ...
    $('input[name="DiscountTarget"]').on('onSomeBrand', function () {
        let myid = $(this).attr('data-id');
        $.ajax({
            url: "/Admin/Discount/ChooseBrandsForDiscountTarget",
            type: "POST",
            data: {
                id: myid
            },
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">هدف تخفیف تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    try {
        ...
        $('.add-discounttarget-product__submit-button').click(function (e) {
            ...
            if (proId === -1) {
                $('.error-product-discount-target').removeClass('d-none').html('انتخاب محصول الزامی است');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">محصول مورد نظر اضافه شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(myParent).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">محصول مورد نظر از این تخفیف حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(myParent).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">دسته بندی مورد نظر از این تخفیف حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(myParent).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">برند مورد نظر از این تخفیف حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('.discount-conditions__submit-button').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات ذخیره شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input[name="IsForAllCustomers"]').change(function (e) {
        ...
        $.ajax({
            url: "/Admin/Discount/EditCustomerDiscount",
            type: "POST",
            data: {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    $(myParent).remove();
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">مشتری مورد نظر از این تخفیف حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('.discount-date__submit-button').click(function (e) {
        ...
        if (from[0] > to[0]) {
            $('.error-discount-date')
                .removeClass('d-none')
                .html('تاریخ انقضا باید تاریخی بعد از تاریخ فعالسازی انتخاب گردد');
            return false;
        ...
        if (activationDate === null || activationDate.trim() === "") {
            $('.error-discount-date')
                .removeClass('d-none')
                .html('وارد کردن هر دو تاریخ الزامی است');
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تاریخ تخفیف تغییر یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    if (val) {
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تخفیف انتشار یافت</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار تخفیف لغو گردید</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
    ...
    $(document).on('click','#discount-list__pageination-buttons-container .pagination--button',function (e) {
        ...
        $.ajax({
            url: "/Admin/Discount/DiscountList",
            type: "POST",
            data: {
                pageIndex: myIndex,
                sortType: sortType,
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تخفیف های انتخاب شده انتشار یافتند</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار تخفیف مورد نظر لغو گردید</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('#special-discount-list__pageination-buttons-container .pagination--button').click(function (e) {
        let myIndex = $(this).attr('data-page-index');
        $.ajax({
            url: "/Admin/SpecialDiscount/SpecialDiscountList",
            type: "POST",
            data: {
                pageIndex: myIndex
            },
    ...
    $('#special-discount-sortandfilter__pageination-buttons-container .pagination--button').click(function (e) {
        ...
        $.ajax({
            url: "/Admin/Search/SpecialDiscountSortAndFilter",
            type: "POST",
            data: {
                sortType: myVal,
                pageIndex: myIndex
    ...
    $('#special-discount-search__pageination-buttons-container .pagination--button').click(function (e) {
        ...
        $.ajax({
            url: "/Admin/Search/SpecialDiscountSearchText",
            type: "POST",
            data: {
                text: myVal,
                pageIndex: myIndex
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">پیشنهادات شگفت انگیز انتخاب شده انتشار یافتند</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار پیشنهاد شگفت انگیز مورد نظر لغو گردید</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
            ...
            success: function (data) {
                if (data) {
                    if (status) {
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حساب کاربری فعال شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حساب کاربری غیرفعال شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
    ...
    $('.customer-totalInformation__submit-button').click(function (e) {
        ...
        if (fName === null || fName.trim() === "") {
            ...
            $('.error-total-information__mobile').removeClass('d-none')
                .html('وارد کردن شماره همراه الزامی است');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === 101) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات با موفقیت ذخیره شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    $('input[name="Mobile"]').css('border-color', 'red');
                    $('.error-total-information__mobile').removeClass('d-none')
                        .html('این شماره موبایل قبلا ثبت شده است');
                } else if (data === 103) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در ویرایش اطلاعات</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        customerRole.listen('MDCSelect:change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">سطح دسترسی تغییر یافت</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                ...
                success: function (data) {
                    if (data) {
                        if (val === "true") {
                            ...
                            UIkit.notification({
                                message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حساب کاربری غیر فعال شد</span>',
                                status: 'primary',
                                pos: 'top-center',
                                timeout: 5000
                            });
    ...
    $('.blog-category__submit-button').click(function (e) {
        ...
        if (blogCategoryTitle === null) {
            $('.error-blog-category-title').removeClass('d-none').html('وارد کردن عنوان الزامی است');
    ...
    try {
        ...
        $('.add-blog__submit-button').click(function (e) {
            ...
            if (title === null) {
                e.stopPropagation();
                e.preventDefault();
                $('.error-blog-title').removeClass('d-none').html('وارد کردن عنوان الزامی است');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data && (value === "true")) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">بلاگ مورد نظر منتشر شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار بلاگ مورد نظر لغو گردید</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    try {
        ...
        blogSort.listen('MDCSelect:change', function () {
            ...
            $.ajax({
                url: "/Admin/Search/BlogSortAndFilter",
                type: "POST",
                data: {
                    sortType: myVal
                },
        ...
        $('input[name="blogSearch"]').keyup(function (e) {
            ...
            let myval = $(this).val();
            $.ajax({
                url: "/Admin/Search/BlogSearchText",
                type: "POST",
                data: {
                    text: myval
                },
    ...
    $('.blog-tags__submit-button').click(function (e) {
        ...
        if (myTagTitle === null) {
            $('.error-blog-tag-title').removeClass('d-none').html('وارد کردن عنوان تگ الزامی است');
    ...
    $('.blog-seo-settings__submit-button').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات انجام شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    if (value) {
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">بلاگ انتشار یافت</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار بلاگ لغو شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
    ...
    $('.add-new-faq__submit-button').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                UIkit.notification({
                    message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">پرسش و پاسخ جدید اضافه شد</span>',
                    status: 'primary',
                    pos: 'top-center',
                    timeout: 5000
                });
    ...
    $(document).on('click', '#blog-comment-tab', function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "/Admin/Comments/BlogCommentTab",
            type: "POST",
            error: function (xhr) { alert(xhr.responseText); },
            beforeSend: function () { $('#progress-loader').removeClass('d-none'); },
            success: function (data) {
    ...
    $(document).on('click', '#reply-comment-modal .reply-comment-submit-button',function (e) {
        ...
        if ($.trim(replyDescription) === null || $.trim(replyDescription) === "") {
            $('.error-reply-description').removeClass('d-none').html('وارد کردن توضیحات الزامی است');
            return false;
        }
    ...
    $(document).on('click', '.comment-list-items__link', function (e) {
        ...
        $.ajax({
            url: "/Admin/Comments/CommentsOfThisProduct",
            type: "POST",
            data: {
                productId: productId
            },
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">کامنت مورد نظر انتشار یافت</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">کامنت مورد نظر حذف شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $(document).on('click', '#blog-reply-comment-modal .reply-comment-submit-button', function (e) {
        ...
        let commentId = $(this).attr('data-commentId');
        $.ajax({
            url: "/Admin/Comments/AddBlogReplyCommentFromAdmin",
            type: "POST",
            data: {
                commentId: commentId,
                replyDescription: replyDescription
    ...
    $(document).on('click', '.comment-list-items__link', function (e) {
        ...
        $.ajax({
            url: "/Admin/Comments/CommentsOfThisBlog",
            type: "POST",
            data: {
                blogId: blogId
            },
    ...
    $(document).on('click', '.reply-ticket__submit-button', function (e) {
        ...
        if ($.trim(replyDescription) === null || $.trim(replyDescription) === "") {
            $('.error-replyTicketDescription').removeClass('d-none').html('وارد کردن توضیحات الزامی است');
            return false;
        }
        $.ajax({
            url: "/Admin/Messages/AddReplyTicket",
            type: "POST",
            data: {
                replyDescription: replyDescription,
                ticketId: ticketId
    ...
    $('.notification__submit-button').click(function (e) {
        ...
        if ($.trim(mainText) === null || $.trim(mainText)==="") {
            $('.error-mainText').removeClass('d-none').html('وارد کردن متن الزامی است');
            return false;
        }
        if ($.trim(linkText) === null || $.trim(linkText) === "") {
            $('.error-linkText').removeClass('d-none').html('وارد کردن لینک الزامی است');
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییرات ثبت شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    if (isPublished) {
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">اعلان ویژه منتشر شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">انتشار اعلان ویژه لغو گردید</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    if (isBlock) {
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">دسترسی موتورهای جستجوگر مسدود شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
                        ...
                        UIkit.notification({
                            message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">دسترسی موتورهای جستجوگر باز شد</span>',
                            status: 'primary',
                            pos: 'top-center',
                            timeout: 5000
                        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حساب کاربران انتخاب شده فعال شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">حساب کاربری مورد نظر غیر فعال شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input#Input_TitlePage,input#TitlePage').keyup(function () {
        ...
        if (!myval.length > 0) {
            $('#title-page-preview').html("عنوان صفحه | پیش فرض");
        }
    });
    ...
    $('textarea#Input_MetaDescription,textarea#MetaDescription').keyup(function () {
        ...
        if (!myval.length > 0) {
            $('#metadescription-page-preview').html('توضیحات در صورت خالی بودن به صورت پیش فرض توسط موتور جستجو انتخاب می شود');
        }
    });
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (xhr.responseText === "true") {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تصویر بلاگ تغییر کرد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تغییر تصویر با خطا مواجه شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input[name="Images"]').change(function () {
        ...
        xhr.open('POST', '/Admin/Products/Upload');
        xhr.send(formData);
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                if (xhr.responseText === "true") {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            UIkit.notification({
                                message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تصاویر جدید بارگذاری شد</span>',
                                status: 'primary',
                                pos: 'top-center',
                                timeout: 5000
                            });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در آپلود تصاویر</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (xhr.responseText === "true") {
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">تصویر جدید ذخیره شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در آپلود تصویر</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    $('input[name="HomeSliderImages"]').change(function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (xhr.responseText === "true") {
                    $.ajax({
                        url: "/Admin/HomePage/SliderImageList/",
                        type: "POST",
                        data: {
                            homeId: myid
                        },
    ...
    $('input[name="MobileHomeSliderImages"]').change(function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (xhr.responseText === "true") {
                    $.ajax({
                        url: "/Admin/HomePage/MobileSliderImageList/",
                        type: "POST",
                        data: {
                            homeId: myid
                        },
    ...
    $(document).on('click', '.targetLink-imageslider-form-button', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">لینک مقصد با موفقیت ذخیره شد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
                    ...
                    UIkit.notification({
                        message: '<span class="material-icons-outlined red-lighten-7 mx-2 position-relative" style="top:6px">notifications_active</span><span class="IRANSans_Light fontsize-14" dir="rtl">خطا در تغییر لینک مقصد</span>',
                        status: 'primary',
                        pos: 'top-center',
                        timeout: 5000
                    });
    ...
    function quillInitialize(elem) {
        ...
        $(elem).click(function () {
            quill.format('align', 'right');   // right aligns the first line
