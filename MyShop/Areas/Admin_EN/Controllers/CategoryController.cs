...
namespace MyShop.Areas.Admin.En.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [Route("En/Admin/Category")]
        [Route("En/Admin/Category/CreateCategory")]
        [HttpGet]
        ...
        //For Sub Categories
        [Route("En/Admin/Category/CreateCategory/{id}")]
        [HttpGet]
        ...
        [Route("En/Admin/Category/EditCategory/{id}")]
        [HttpGet]
        [ResponseCache(NoStore = true)]
        ...
        [Route("En/Admin/Category/EditCategory/{catId}")]
        [HttpPost]
        [ResponseCache(NoStore = true)]
        ...
        [Route("En/Admin/Category/DeleteCategory")]
        [HttpPost]
        [ResponseCache(NoStore = true)]
