...
namespace MyShop.Areas.Admin.En.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [Route("En/Admin/Products/ProductList")]
        [HttpPost]
        ...
        [Route("En/Admin/Products/CreateProduct")]
        [HttpPost]
        ...
        //Edit Product Page
        [Route("En/Admin/Products/EditProduct/{id}")]
        [HttpGet]
        ...
        [Route("En/Admin/Products/EditTotalInformation/{productId}")]
        [HttpPost]
        ...
        [Route("En/Admin/Products/Upload")]
        [HttpPost]
        ...
        [Route("En/Admin/Products/EditProductPricing/{id}")]
        [HttpPost]
        ...
        [Route("En/Admin/Products/DeleteProduct")]
        [HttpPost]
        ...
        [Route("En/Admin/Products/DeleteGroupProduct")]
        [HttpPost]
